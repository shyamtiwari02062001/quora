const SideContentText = ` Cricket is a bat-and-ball game played between two teams of eleven
...
wicket with the bat and then running between the wickets, while the
bowling and fielding side tries to prevent this (by preventing the ball
from leaving the field, and getting the ball to either wicket) and
...
export default SideContentText;